<!-- 
Replace the following in this doc:
  [COURSE_NAME] with your course's name
  [COURSE_URL] with your course's URL on Learning Lab
  [COURSE_REPO] with a link to your course repository
  [TEMPLATE_REPO] with a link to your template repository
-->
...
<h1 align="center">Course: [COURSE_NAME] </h1>

This repository powers the Learning Lab course [_COURSE_NAME_]([COURSE_URL]). 

Every Learning Lab course is made up of:
- a [course repository]([COURSE_REPO]), and
- a [template repository]([TEMPLATE_REPO])
